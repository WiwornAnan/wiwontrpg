...
renderEgoRing(20);renderRingNumerals("ambient-numerals",109,8,1,22,"#e8f9f2",PERMS.ambient);renderRingNumerals("fortuity-numerals",63,10,-1,14,"#fff6e0",PERMS.fortuity);buildChips();buildSeg("ego-seg","egoMode");buildSeg("ambient-seg","ambientMode");buildSeg("fortuity-seg","fortuityMode");document.getElementById("rollBtn").addEventListener("click",rollAll);window.__wiwonRoll=rollAll;
